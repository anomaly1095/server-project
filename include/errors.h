...
#define ERROR_DB_NAME_LENGTH_M "Invalid db name length: %s\n"
#define ERROR_DB_NAME_CHAR_M "Invalid character in db name: %c\n"
#define ERROR_DB_INIT_M   "Failed to initialize db connection\n"
#define ERROR_DB_CONNECT_M "Failed to connect to MySQL server: %s\n"
#define ERROR_DB_CREATE_M "Failed to create database: %s\n"
#define ERROR_DB_SELECT_M "Failed to select database: %s\n"
#define ERROR_DB_TABLES_M "Failed to create tables: %s\n"
#define SUCCESS_DB_CREATED_M "Database and tables created successfully!\n"
